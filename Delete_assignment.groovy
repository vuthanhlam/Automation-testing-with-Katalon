...
WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/div_Danh sch bi tp'))
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Hc liu - Sch Mm/div_Xa bi tp thnh cng'))
