...
WebUI.setText(findTestObject('Object Repository/Page_ng nhp  Sch Mm/input_a ch email_useremail'), 'lam9a1yb@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_ng nhp  Sch Mm/input_Mt khu_userpassword'), 'xY+SMxDLnc28ILza2E7vYQ==')
...
WebUI.verifyElementVisible(findTestObject('Page_Hc liu - Sch Mm/div_Cp m thnh cng'))
